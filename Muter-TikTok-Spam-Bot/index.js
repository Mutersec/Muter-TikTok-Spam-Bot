...
function ascii() {
  ...
  console.log(chalk.white('    https://github.com/Mutersec/Muter-TikTok-Spam-Bot'),chalk.grey(" | "),chalk.white('https://github.com/Mutersec/Muter-TikTok-Spam-Bot'),chalk.grey(" | "),chalk.white('https://github.com/Mutersec/Muter-TikTok-Spam-Bot'),)
  console.log(chalk.grey('----------------------------------------------------------------------------------------------------------------------\n'))
}
